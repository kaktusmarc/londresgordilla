  ...
  days: [
    ...
    },
    {
      ...
      stops: [
        ...
        { time: '11:15', name: 'Piccadilly Circus', blurb: 'De día. Línea Piccadilly directa desde Knightsbridge.', lat: 51.5100, lng: -0.1345, wiki: 'Piccadilly Circus' },
        { time: '11:30', name: 'Regent Street & Hamleys', blurb: 'Parada obligatoria: la juguetería. Calculad 45 min.', lat: 51.5126, lng: -0.1397, wiki: 'Hamleys', fix: 'La original caía en Oxford Circus; Hamleys está en el 188-196 de Regent St.' },
        { time: '12:15', name: 'Carnaby Street', blurb: 'Calle peatonal con ambiente y tiendas.', lat: 51.5133, lng: -0.1389, wiki: 'Carnaby Street', fix: 'Movida ~80 m al este, sobre la propia Carnaby St.' },
        { time: '12:45', name: 'Chinatown / Soho', blurb: 'De día.', lat: 51.5114, lng: -0.1315, wiki: 'Soho, London' },
        { time: '13:15', name: 'Leicester Square & Lego Store', blurb: 'Segunda parada obligatoria.', lat: 51.5106, lng: -0.1300, wiki: 'Leicester Square', fix: 'La Lego Store está en Swiss Court, lado oeste de la plaza.' },
        { time: '13:45', name: 'Covent Garden', blurb: 'Comer aquí y rematar las compras en el mercado. Hasta las 15:00.', lat: 51.5119, lng: -0.1226, wiki: 'Covent Garden', fix: 'Centrada en el Market Building.' },
        { time: '15:15', name: 'St Paul’s Cathedral', blurb: 'Empieza la City. Metro Holborn–St Paul’s o 20 min andando.', lat: 51.5138, lng: -0.0984, wiki: "St Paul's Cathedral" },
        { time: '15:50', name: 'Millennium Bridge', blurb: 'Justo detrás de la catedral.', lat: 51.5095, lng: -0.0986, wiki: 'Millennium Bridge, London' },
        { time: '16:20', name: 'Leadenhall Market', blurb: 'Mercado victoriano cubierto.', lat: 51.5128, lng: -0.0833, wiki: 'Leadenhall Market' },
        { time: '16:45', name: 'St Dunstan in the East', blurb: 'Ruinas-jardín escondidas.', lat: 51.5096, lng: -0.0814, wiki: 'St Dunstan-in-the-East', fix: 'La original caía 160 m al oeste, dentro de Monument.' },
        { time: '17:10', name: 'Tower of London & Tower Bridge', blurb: 'Solo exterior: a esta hora ya no da tiempo a entrar.', lat: 51.5081, lng: -0.0759, wiki: 'Tower Bridge' },
